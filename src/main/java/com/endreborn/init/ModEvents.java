            ...
            if (event.getSource().getDirectEntity() != null) {
                if (!entity.level.isClientSide) {
                    for(int i = 0; i < 16; ++i) {
                        ...
                        double d4 = Mth.clamp(entity.getY() + (double)(ThreadLocalRandom.current().nextInt(12) - 6), (double)entity.level.getMinBuildHeight(), (double)(entity.level.getMinBuildHeight() + ((ServerLevel)entity.level).getLogicalHeight() - 1));
