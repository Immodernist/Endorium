...
public class ModItems {
    ...
    public static DeferredItem<Item> CURIOUS_ENDORIUM_SWORD = register(() -> new UpgradableSwordItem(ModTiers.CURIOUS_ENDORIUM, new Item.Properties().attributes(SwordItem.createAttributes(ModTiers.CURIOUS_ENDORIUM, 3, -2.4f)), 1, 0), "curious_endorium_sword");
    public static DeferredItem<Item> CURIOUS_ENDORIUM_AXE = register(() -> new UpgradableAxeItem(ModTiers.CURIOUS_ENDORIUM, new Item.Properties().attributes(AxeItem.createAttributes(ModTiers.CURIOUS_ENDORIUM,5f, -3.0f)), 1, 0), "curious_endorium_axe");
    public static DeferredItem<Item> CURIOUS_ENDORIUM_SHOVEL = register(() -> new UpgradableShovelItem(ModTiers.CURIOUS_ENDORIUM, new Item.Properties().attributes(ShovelItem.createAttributes(ModTiers.CURIOUS_ENDORIUM,1.5f, -3f)), 1, 0), "curious_endorium_shovel");
    public static DeferredItem<Item> CURIOUS_ENDORIUM_HOE = register(() -> new UpgradableHoeItem(ModTiers.CURIOUS_ENDORIUM, new Item.Properties().attributes(HoeItem.createAttributes(ModTiers.CURIOUS_ENDORIUM,-4, 0.0f)), 1, 0), "curious_endorium_hoe");
    public static DeferredItem<Item> CURIOUS_ENDORIUM_PICKAXE = register(() -> new UpgradablePickaxeItem(ModTiers.CURIOUS_ENDORIUM, new Item.Properties().attributes(PickaxeItem.createAttributes(ModTiers.CURIOUS_ENDORIUM,1, -2.8f)), 1, 0), "curious_endorium_pickaxe");
    ...
    public static DeferredItem<Item> MYSTERIOUS_ENDORIUM_SWORD = register(() -> new UpgradableSwordItem(ModTiers.MYSTERIOUS_ENDORIUM, new Item.Properties().attributes(SwordItem.createAttributes(ModTiers.MYSTERIOUS_ENDORIUM, 3, -2.4f)), 0, 1), "mysterious_endorium_sword");
    public static DeferredItem<Item> MYSTERIOUS_ENDORIUM_AXE = register(() -> new UpgradableAxeItem(ModTiers.MYSTERIOUS_ENDORIUM, new Item.Properties().attributes(AxeItem.createAttributes(ModTiers.MYSTERIOUS_ENDORIUM,5f, -3.0f)), 0, 1), "mysterious_endorium_axe");
    public static DeferredItem<Item> MYSTERIOUS_ENDORIUM_SHOVEL = register(() -> new UpgradableShovelItem(ModTiers.MYSTERIOUS_ENDORIUM, new Item.Properties().attributes(ShovelItem.createAttributes(ModTiers.MYSTERIOUS_ENDORIUM,1.5f, -3f)), 0, 1), "mysterious_endorium_shovel");
    public static DeferredItem<Item> MYSTERIOUS_ENDORIUM_HOE = register(() -> new UpgradableHoeItem(ModTiers.MYSTERIOUS_ENDORIUM, new Item.Properties().attributes(HoeItem.createAttributes(ModTiers.MYSTERIOUS_ENDORIUM,-4, 0.0f)), 0, 1), "mysterious_endorium_hoe");
    public static DeferredItem<Item> MYSTERIOUS_ENDORIUM_PICKAXE = register(() -> new UpgradablePickaxeItem(ModTiers.MYSTERIOUS_ENDORIUM, new Item.Properties().attributes(PickaxeItem.createAttributes(ModTiers.MYSTERIOUS_ENDORIUM,1, -2.8f)), 0, 1), "mysterious_endorium_pickaxe");
