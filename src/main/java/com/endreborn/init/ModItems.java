...
public class ModItems {
    ...
    public static void setup() {
        ...
        CURIOUS_ENDORIUM_SWORD = registerItem(() -> new UpgradableSwordItem(ModTiers.CURIOUS_ENDORIUM, 3, -2.4f, new Item.Properties(), 1, 0), "curious_endorium_sword");
        CURIOUS_ENDORIUM_AXE = registerItem(() -> new UpgradableAxeItem(ModTiers.CURIOUS_ENDORIUM, 5f, -3.1f, new Item.Properties(), 1, 0), "curious_endorium_axe");
        CURIOUS_ENDORIUM_SHOVEL = registerItem(() -> new UpgradableShovelItem(ModTiers.CURIOUS_ENDORIUM, 1.5f, -3f, new Item.Properties(), 1, 0), "curious_endorium_shovel");
        CURIOUS_ENDORIUM_HOE = registerItem(() -> new UpgradableHoeItem(ModTiers.CURIOUS_ENDORIUM, -4, -1f, new Item.Properties(), 1, 0), "curious_endorium_hoe");
        CURIOUS_ENDORIUM_PICKAXE = registerItem(() -> new UpgradablePickaxeItem(ModTiers.CURIOUS_ENDORIUM, 1, -2.8f, new Item.Properties(), 1, 0), "curious_endorium_pickaxe");

        MYSTERIOUS_RELIC = registerItem(() -> new Item(new Item.Properties()), "mysterious_relic");
        MYSTERIOUS_ENDORIUM_SWORD = registerItem(() -> new UpgradableSwordItem(ModTiers.MYSTERIOUS_ENDORIUM, 3, -2.4f, new Item.Properties(), 0, 1), "mysterious_endorium_sword");
        MYSTERIOUS_ENDORIUM_AXE = registerItem(() -> new UpgradableAxeItem(ModTiers.MYSTERIOUS_ENDORIUM, 5f, -3.1f, new Item.Properties(), 0, 1), "mysterious_endorium_axe");
        MYSTERIOUS_ENDORIUM_SHOVEL = registerItem(() -> new UpgradableShovelItem(ModTiers.MYSTERIOUS_ENDORIUM, 1.5f, -3f, new Item.Properties(), 0, 1), "mysterious_endorium_shovel");
        MYSTERIOUS_ENDORIUM_HOE = registerItem(() -> new UpgradableHoeItem(ModTiers.MYSTERIOUS_ENDORIUM, -4, -1f, new Item.Properties(), 0, 1), "mysterious_endorium_hoe");
        MYSTERIOUS_ENDORIUM_PICKAXE = registerItem(() -> new UpgradablePickaxeItem(ModTiers.MYSTERIOUS_ENDORIUM, 1, -2.8f, new Item.Properties(), 0, 1), "mysterious_endorium_pickaxe");
