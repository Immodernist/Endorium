...
public class ModBlocks {
    ...
    public static final Block FARSTONE_BRICKS_WALL  = new WallBlock(AbstractBlock.Settings.copy(FARSTONE));
    ...
    public static void setup() {
        ...
        Registry.register(Registries.BLOCK, Identifier.of(Endorium.MODID, "farstone_brick_wall"), FARSTONE_BRICKS_WALL);
        Registry.register(Registries.ITEM, Identifier.of(Endorium.MODID, "farstone_brick_wall"), new BlockItem(FARSTONE_BRICKS_WALL, new Item.Settings()));
